 ...
 */
package com.cinema.vcinemaprojectionscreen.server;
...
import com.cinema.vcinemaprojectionscreen.Servermanager;
...
public class VideoResourceServlet extends DefaultServlet {
    ...
    public Resource getResource(String pathInContext) {
        ...
        try {
            ...
            Cursor cursor = Servermanager.getInstance().mContext.getContentResolver().query(
